...
interface PayBillModalProps {
  bill: BuyerBill;
  onClose: () => void;
  onPay: (method: 'online' | 'offline') => void;
  isLoading: boolean;
}

export const PayBillModal: React.FC<PayBillModalProps> = ({ bill, onClose, onPay, isLoading }) => {
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto flex-1 space-y-6">
          <div className="text-center">
            ...
            <div className="text-xs text-gray-400 mt-1">账单编号: {bill.id}</div>
          </div>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                ...
                className={`p-3 rounded-xl border-2 text-sm font-bold flex flex-col items-center justify-center gap-2 transition-all ${
