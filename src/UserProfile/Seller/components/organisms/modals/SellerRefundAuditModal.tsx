        ...
        <div className="bg-gray-50 p-4 rounded-xl border border-gray-100 mb-6">
          ...
          <div className="flex justify-between items-center mb-4">
            <div className="flex items-center gap-2">
              <span className="font-bold text-gray-900">{selectedItem?.orderId}</span>
              <span className="text-[10px] bg-blue-50 text-blue-600 px-1.5 rounded border border-blue-100">
                企业版订阅
              </span>
            </div>
            <span className="font-bold text-red-600 text-lg">¥ {selectedItem?.amount}</span>
          </div>
          <div className="grid grid-cols-2 gap-4 text-xs">
            <div>
              <span className="text-gray-400 block mb-1">买家账户</span>
              <span className="text-gray-800 font-medium">{selectedItem?.buyer}</span>
            </div>
            <div>
