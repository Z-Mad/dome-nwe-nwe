// components/profile/modals/BillDetailModal.tsx
...
export const BillDetailModal: React.FC<BillDetailModalProps> = ({ bill, onClose, onOpenModal }) => {
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-[60] flex items-center justify-center p-4 animate-in fade-in">
      <div className="bg-white w-full max-w-3xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-6 overflow-y-auto flex-1 bg-gray-50">
          <div className="bg-white rounded-xl border border-gray-100 p-6 mb-6 shadow-sm flex justify-between items-center">
            ...
            <div className="text-right">
              ...
              <div className={`text-lg font-bold ${bill.status === 'paid' ? 'text-green-600' : 'text-red-600'}`}>
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm overflow-hidden">
            ...
            <table className="w-full text-sm text-left">
                  ...
                  <React.Fragment key={index}>
                    <tr className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-6 py-4 text-gray-600">
                        <span className="px-2 py-1 bg-gray-100 text-gray-600 rounded text-xs font-medium">{detail.type}</span>
                      </td>
              ...
              <tfoot className="bg-gray-50 font-bold border-t border-gray-100">
                <tr>
                  <td colSpan={3} className="px-6 py-4 text-right text-gray-600">合计：</td>
        ...
        <div className="px-6 py-4 border-t border-gray-100 bg-white flex justify-end gap-3">
          <button onClick={onClose} className="px-6 py-2.5 bg-gray-100 text-gray-700 font-bold rounded-xl hover:bg-gray-200 transition-colors text-sm">
            关闭
          </button>
          {bill.status === 'unpaid' && (
            <button
