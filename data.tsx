...
export const MOCK_AGENTS: Record<string, AgentData> = {
  '1': {
    ...
    detailsModules: [
      {
        ...
        content:
          '传统冷轧生产高度依赖老师傅的经验来调整轧机参数（如弯辊力、冷却液分布），往往存在滞后性，导致板形缺陷频发。数字冷轧质量管理智能体不仅仅是一个工具，它固化了宝信软件40年的行业Know-How，将机理模型 (Process Model)与深度学习 (Deep Learning)完美融合。',
        data: {
          stats: [
        ...
        data: {
          bad: {
            ...
            items: [
              {
                title: '视觉疲劳漏检',
                desc: '人工质检员在高强度作业下，对微小裂纹的漏检率高达 5-8%。',
              },
              {
                title: '参数调整滞后',
                desc: '发现板形不良后再调整轧机，往往已经产生了数百米的次品钢卷。',
              },
              {
                title: '质量黑箱',
                desc: '质量数据分散在不同系统（L1/L2/MES），无法进行全生命周期追溯。',
              },
            ],
          },
          good: {
            ...
            items: [
              {
                title: '全时段机器视觉',
                desc: '7x24小时不知疲倦的监控，对 < 0.2mm 的微小缺陷识别率 > 99.2%。',
              },
              {
                title: '毫秒级闭环控制',
                desc: '检测到异常瞬间，直接下发 PLC 调整指令，将缺陷扼杀在萌芽。',
              },
              {
                title: '全息数字档案',
                desc: '每卷钢都有独立的“数字身份证”，记录从原料到成品的全部工艺参数。',
              },
            ],
          },
        },
      ...
      },
      {
        ...
        data: [
          {
            title: '开箱即用的场景闭环',
            desc: '无需从零开发，预置了针对连续退火、热镀锌等标准产线的控制策略。企业只需配置设备参数，即可实现主要质量指标的自动管控。',
            icon: 'target',
          },
          {
            title: '物理实体的数字化骨架',
            desc: '不仅仅是算法，更交付了一套标准化的数据结构（JSON/Excel），定义了轧机、卷取机等核心对象的属性、关系与接入规则。',
            icon: 'database',
          },
          {
            title: '专家思维链 (CoT)',
            desc: '内置“观察-诊断-决策”的专家推理模型，自动处理板形波动与厚度异常。',
            icon: 'cpu',
          },
        ],
      },
      {
        ...
        data: [
          {
            title: '板形自动控制 (AFC)',
            desc: '替代人工进行弯辊力与冷却液的实时调节，消除人为滞后。',
            icon: 'factory',
          },
          {
            title: '表面缺陷根因阻断',
            desc: '视觉识别到周期性缺陷时，自动反推辊系故障并触发停机预警。',
            icon: 'shield',
          },
        ],
      },
    ...
    deliverables: [
      {
        title: '专家诊断逻辑库.py',
        desc: '包含2000+条针对冷轧常见质量问题的IF-THEN专家规则代码。',
        type: 'algorithm',
      },
      {
        title: '机组对象图谱.json',
        desc: '描述轧线设备拓扑关系与工艺参数绑定的标准化JSON文件。',
        type: 'model',
      },
      {
        title: '闭环控制应用包',
        desc: '可直接下发至L2系统的控制指令集接口定义。',
        type: 'model',
      },
      {
        title: '质量异常处理SOP',
        desc: 'AI生成的标准化作业程序，指导现场人员快速处置。',
        type: 'report',
      },
    ],
    dataPreview: {
      ...
      rows: [
        {
          time: '10:23:05.120',
          event: '出口板形 I-Unit > 15',
          logic: '匹配规则#802: 浪形主要集中在双边 -> 判定为弯辊力不足',
          decision: <span className="text-blue-600 font-bold">增加弯辊力 +50kN</span>,
        },
        {
          time: '10:24:12.050',
          event: '厚度偏差 > 5μm',
          logic: '匹配规则#104: 轧制速度稳定 & 张力波动 -> 判定为来料楔形',
          decision: <span className="text-blue-600 font-bold">调整两侧压下量差值</span>,
        },
        {
          time: '10:25:30.800',
          event: '视觉报警: 周期辊印',
          logic: '计算周长 942mm -> 匹配2#机架工作辊直径',
          decision: <span className="text-red-600 font-bold">触发换辊预警 (Lvl 2)</span>,
        },
      ],
    },
    compliance: {
  ...
  '2': {
    ...
    detailsModules: [
      {
        ...
        content:
          '本智能体基于2024-2025年度全行业千万吨级生产数据，构建了冷轧产品质量竞争力评估模型。它不只是一份静态的报告，更是一个动态的对标分析工具。企业导入自身数据后，可即时获取与行业Top 10%标杆企业的差距分析，为工艺优化提供精准导航。',
        data: {
          theme: 'purple',
          stats: [
      ...
      },
      {
        ...
        data: [
          {
            title: '全景对标诊断',
            desc: '一键生成《企业质量竞争力诊断报告》，从厚度精度(Cpk)、表面等级、力学性能三个维度进行行业排位。',
            icon: 'chart',
          },
          {
            title: '动态基准库',
            desc: '不再是死板的标准，而是基于上千万吨实绩数据生成的动态分布曲线 (Distribution Curve)，真实反映行业技术水位。',
            icon: 'database',
          },
          {
            title: '行业洞察蓝皮书',
            desc: '内嵌《2025中国冷轧行业发展年度报告》完整版，包含专家对双碳政策、新钢种研发趋势的深度解读。',
            icon: 'book',
          },
        ],
      },
    ...
    deliverables: [
      {
        title: '企业对标诊断报告.pdf',
        desc: '输入企业自身数据，自动生成与行业基准的差异分析报告。',
        type: 'chart',
      },
      {
        title: '行业质量基准数据库',
        desc: '有效期内的在线BI系统访问权限，支持自定义查询各钢种指标。',
        type: 'dashboard',
      },
      {
        title: '2025行业蓝皮书(电子版)',
        desc: '包含完整图文分析的数字化出版物（300页+），支持全文检索。',
        type: 'report',
      },
      {
        title: '季度趋势增量包',
        desc: '每季度推送最新的行业数据增量包与简报。',
        type: 'model',
      },
    ],
    dataPreview: {
      ...
      rows: [
        {
          category: '尺寸精度',
          metric: '汽车板厚度Cpk',
          benchmark: <span className="text-blue-600 font-bold">1.67</span>,
          industry_avg: '1.33',
          insight: '建议引入精轧机架液压AGC前馈模型',
        },
        {
          category: '表面质量',
          metric: 'O5板合格率',
          benchmark: <span className="text-blue-600 font-bold">96.5%</span>,
          industry_avg: '92.1%',
          insight: '需加强连退炉辊表面涂层管理',
        },
        {
          category: '性能稳定性',
          metric: '屈服强度波动',
          benchmark: <span className="text-blue-600 font-bold">±10MPa</span>,
          industry_avg: '±25MPa',
          insight: '优化热轧卷取温度(CT)控制精度',
        },
      ],
    },
    compliance: {
    ...
    detailsModules: [
      ...
      },
      {
        ...
        data: [
          {
            title: '温度场建模',
            desc: '基于热力学公式的三维温度场重构。',
            icon: 'fire',
          },
          {
            title: '炉壁侵蚀预测',
            desc: '结合历史检修数据的侵蚀速率估算。',
            icon: 'alert',
          },
        ],
      },
