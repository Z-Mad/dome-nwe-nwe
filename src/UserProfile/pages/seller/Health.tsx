        ...
        <div className="space-y-4 font-mono text-sm">
          ...
          {diagStep >= 4 && (
            <div className="mt-4 pt-4 border-t border-gray-700 text-green-400 font-bold">
              诊断完成，系统运行正常。
              <button onClick={stopDiagnosis} className="ml-4 text-white underline text-xs">
                关闭
              </button>
            </div>
          )}
  ...
  return (
    <div className="space-y-4 animate-in fade-in">
      <div className="flex justify-between items-center mb-2">
        ...
        <button onClick={startDiagnosis} className="text-indigo-600 text-sm font-bold hover:underline">
          开始诊断
        </button>
      </div>
