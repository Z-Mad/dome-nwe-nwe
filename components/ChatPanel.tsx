        ...
        content: (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div className="bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-green-600 text-xs bg-green-50 px-1 rounded flex items-center">
                    <CheckCircle size={10} className="mr-1" /> 合格
                  </span>
                </div>
              ...
              <div className="bg-white p-3 rounded-lg border border-gray-100 shadow-sm">
                ...
                <div className="flex items-baseline gap-2">
                  ...
                  <span className="text-yellow-600 text-xs bg-yellow-50 px-1 rounded flex items-center">
                    <AlertTriangle size={10} className="mr-1" /> 波动
                  </span>
                </div>
                <div className="w-full bg-gray-200 h-1 mt-2 rounded-full overflow-hidden">
              ...
              <div className="bg-white p-3 rounded-lg border border-gray-100 shadow-sm col-span-2">
                <div className="flex justify-between items-start">
                  ...
                  <div className="bg-red-50 text-red-600 px-2 py-1 rounded text-xs font-medium">
                    等级 C
                  </div>
                </div>
            ...
            <div className="bg-blue-50/50 p-3 rounded-lg border border-blue-100 text-sm">
              <p className="font-semibold text-blue-800 mb-1 text-xs uppercase tracking-wider">
                AI 诊断建议:
              </p>
            ...
            <div className="flex gap-2 mt-2">
              <button className="flex-1 bg-white border border-gray-200 text-gray-600 py-2 rounded-lg text-xs hover:bg-gray-50">
                查看趋势图
              </button>
              <button className="flex-1 bg-white border border-gray-200 text-gray-600 py-2 rounded-lg text-xs hover:bg-gray-50">
                导出PDF
        ...
        {isThinkingModeOpen && (
          <div className="w-full max-w-lg bg-[#1e1e2d] rounded-3xl p-5 shadow-2xl mb-4 text-white animate-fade-in-up border border-gray-700/50 backdrop-blur-xl">
            <div className="flex justify-between items-center mb-4 border-b border-gray-700/50 pb-2">
              ...
              <button
                onClick={() => setIsThinkingModeOpen(false)}
