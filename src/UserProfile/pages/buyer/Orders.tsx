...
import { Search, Upload, Download, Repeat, FileText, Clock, CheckCircle, Trash2, AlertCircle, AlertTriangle } from 'lucide-react';
import { useOutletContext } from 'react-router-dom';
import { PaymentStatusBadge } from '@/components/Badges';
import { useBuyerOrders } from '../../hooks/useBuyerOrders';

const BuyerOrders: React.FC = () => {
  const { globalOrders, openModal, onNavigate, showToast, onUpdateOrder } = useOutletContext<any>();
  const { localOrders, orderSearch, setOrderSearch, orderStatusFilter, setOrderStatusFilter, deleteOrder } = useBuyerOrders(globalOrders, onUpdateOrder);
